...
def build_index(chunks: list[dict[str, Any]]) -> "BM25Index | None":
    ...
    for c in chunks:
        ...
        id_to_payload[pid] = {
            ...
            "parent_code_snippet": (c.get("parent_code_snippet") or c.get("code_snippet") or "")[:65535],
            "parent_start_line": c.get("parent_start_line", c.get("start_line", 0)),
            "parent_end_line": c.get("parent_end_line", c.get("end_line", 0)),
            ...
            "folder": c.get("folder"),
            "phase": c.get("phase"),
            "include_headers": c.get("include_headers") or [],
